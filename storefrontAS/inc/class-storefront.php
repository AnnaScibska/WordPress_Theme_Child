...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function setup() {
			...
			// Loads wp-content/languages/themes/storefrontAS-it_IT.mo.
			...
			// Loads wp-content/themes/storefrontAS/languages/it_IT.mo.
		...
		public function scripts() {
			 ...
			 * Styles
			 */
			wp_enqueue_style( 'storefrontAS-style', get_template_directory_uri() . '/style.css', '', $storefront_version );
			wp_style_add_data( 'storefrontAS-style', 'rtl', 'replace' );

			wp_enqueue_style( 'storefrontAS-icons', get_template_directory_uri() . '/assets/css/base/icons.css', '', $storefront_version );
			wp_style_add_data( 'storefrontAS-icons', 'rtl', 'replace' );
			...
			wp_enqueue_style( 'storefrontAS-fonts', $fonts_url, array(), null );
			...
			wp_enqueue_script( 'storefrontAS-navigation', get_template_directory_uri() . '/assets/js/navigation' . $suffix . '.js', array(), $storefront_version, true );
			wp_enqueue_script( 'storefrontAS-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix' . $suffix . '.js', array(), '20130115', true );
			...
			if ( has_nav_menu( 'handheld' ) ) {
				...
				wp_localize_script( 'storefrontAS-navigation', 'storefrontScreenReaderText', $storefront_l10n );
			}

			if ( is_page_template( 'template-homepage.php' ) && has_post_thumbnail() ) {
				wp_enqueue_script( 'storefrontAS-homepage', get_template_directory_uri() . '/assets/js/homepage' . $suffix . '.js', array(), $storefront_version, true );
			}
		...
		public function child_scripts() {
			if ( is_child_theme() ) {
				...
				wp_enqueue_style( 'storefrontAS-child-style', get_stylesheet_uri(), array(), $child_theme->get( 'Version' ) );
			}
		}
		...
		public function body_classes( $classes ) {
			...
			if ( true === $cute ) {
				$classes[] = 'storefrontAS-cute';
			}

			// If our main sidebar doesn't contain widgets, adjust the layout to be full-width.
			if ( ! is_active_sidebar( 'sidebar-1' ) ) {
				$classes[] = 'storefrontAS-full-width-content';
			}
			...
			if ( has_nav_menu( 'secondary' ) ) {
				$classes[] = 'storefrontAS-secondary-navigation';
			}
