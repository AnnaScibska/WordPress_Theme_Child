...
if ( ! class_exists( 'Storefront_Jetpack' ) ) :
	...
	class Storefront_Jetpack {
		...
		public function jetpack_scripts() {
			...
			wp_enqueue_style( 'storefrontAS-jetpack-style', get_template_directory_uri() . '/assets/css/jetpack/jetpack.css', '', $storefront_version );
			wp_style_add_data( 'storefrontAS-jetpack-style', 'rtl', 'replace' );
		}
	}
