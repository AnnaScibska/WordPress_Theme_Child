...
if ( ! class_exists( 'Storefront_Customizer' ) ) :
	...
	class Storefront_Customizer {
		...
		public function get_css() {
			...
			ul.menu li a,
			.site-branding h1 a,
			.site-footer .storefrontAS-handheld-footer-bar a:not(.button),
			button.menu-toggle,
			...
			.storefrontAS-handheld-footer-bar,
			.storefrontAS-handheld-footer-bar ul li > a,
			.storefrontAS-handheld-footer-bar ul li.search .site-search,
			button.menu-toggle,
			button.menu-toggle:hover {
			...
			.storefrontAS-handheld-footer-bar ul li.cart .count,
			...
			if ( ! class_exists( 'Storefront_Product_Pagination' ) ) {
				$styles .= '.storefrontAS-product-pagination a {
					color: ' . $storefront_theme_mods['text_color'] . ';
					background-color: ' . $storefront_theme_mods['background_color'] . ';
				}';
			}
			...
			if ( ! class_exists( 'Storefront_Sticky_Add_to_Cart' ) ) {
				$styles .= '
				.storefrontAS-sticky-add-to-cart {
					color: ' . $storefront_theme_mods['text_color'] . ';
					background-color: ' . $storefront_theme_mods['background_color'] . ';
				}

				.storefrontAS-sticky-add-to-cart a:not(.button) {
					color: ' . $storefront_theme_mods['header_link_color'] . ';
				}';
			}
		...
		public function add_customizer_css() {
			wp_add_inline_style( 'storefrontAS-style', $this->get_css() );
			wp_add_inline_style( 'storefrontAS-woocommerce-style', $this->get_woocommerce_css() );
		}
