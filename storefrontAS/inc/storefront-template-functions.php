...
if ( ! function_exists( 'storefront_homepage_header' ) ) {
	...
	function storefront_homepage_header() {
		edit_post_link( __( 'Edit this section', 'storefront' ), '', '', '', 'button storefrontAS-hero__button-edit' );
		?>
	...
	function storefront_product_categories( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product-category' ) ) {
				...
				echo '<section class="storefrontAS-product-section storefrontAS-product-categories" aria-label="' . esc_attr__( 'Product Categories', 'storefront' ) . '">';
	...
	function storefront_recent_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefrontAS-product-section storefrontAS-recent-products" aria-label="' . esc_attr__( 'Recent Products', 'storefront' ) . '">';
	...
	function storefront_featured_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefrontAS-product-section storefrontAS-featured-products" aria-label="' . esc_attr__( 'Featured Products', 'storefront' ) . '">';
	...
	function storefront_popular_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefrontAS-product-section storefrontAS-popular-products" aria-label="' . esc_attr__( 'Popular Products', 'storefront' ) . '">';
	...
	function storefront_on_sale_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefrontAS-product-section storefrontAS-on-sale-products" aria-label="' . esc_attr__( 'On Sale Products', 'storefront' ) . '">';
	...
	function storefront_best_selling_products( $args ) {
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefrontAS-product-section storefrontAS-best-selling-products" aria-label="' . esc_attr__( 'Best Selling Products', 'storefront' ) . '">';
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper' ) ) {
	...
	function storefront_primary_navigation_wrapper() {
		echo '<div class="storefrontAS-primary-navigation"><div class="col-full">';
	}
}
