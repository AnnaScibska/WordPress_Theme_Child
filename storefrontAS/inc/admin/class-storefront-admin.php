	...
	class Storefront_Admin {
		...
		public function welcome_style( $hook_suffix ) {
			...
			if ( 'appearance_page_storefront-welcome' === $hook_suffix ) {
				wp_enqueue_style( 'storefrontAS-welcome-screen', get_template_directory_uri() . '/assets/css/admin/welcome-screen/welcome.css', $storefront_version );
				wp_style_add_data( 'storefrontAS-welcome-screen', 'rtl', 'replace' );
			}
		}
		...
		public function welcome_register_menu() {
			add_theme_page( 'Storefront', 'Storefront', 'activate_plugins', 'storefrontAS-welcome', array( $this, 'storefront_welcome_screen' ) );
		}
