...
if ( ! class_exists( 'Storefront_Plugin_Install' ) ) :
	...
	class Storefront_Plugin_Install {
		...
		public function plugin_install_scripts( $hook_suffix ) {
			...
			wp_enqueue_script( 'storefrontAS-plugin-install', get_template_directory_uri() . '/assets/js/admin/plugin-install' . $suffix . '.js', array( 'jquery', 'updates' ), $storefront_version, 'all' );

			wp_enqueue_style( 'storefrontAS-plugin-install', get_template_directory_uri() . '/assets/css/admin/plugin-install.css', array(), $storefront_version, 'all' );
		}
			...
			if ( current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) {
				if ( is_plugin_active( $plugin_slug . '/' . $plugin_file ) ) {
					...
					$button = array(
						...
						'url'     => '#',
						'classes' => array( 'storefrontAS-button', 'disabled' ),
					);
					...
					$button = array(
						...
						'url'     => $url,
						'classes' => array( 'storefrontAS-button', 'activate-now' ),
					);
					...
					$button = array(
						...
						'url'     => $url,
						'classes' => array( 'storefrontAS-button', 'sf-install-now', 'install-now', 'install-' . $plugin_slug ),
					);
