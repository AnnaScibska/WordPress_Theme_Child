		...
		if ( trigger.length > 0 ) {
			var stickyAddToCartToggle = function() {
				if ( ( trigger[0].getBoundingClientRect().top + trigger[0].scrollHeight ) < 0 ) {
					stickyAddToCart[0].classList.add( 'storefrontAS-sticky-add-to-cart--slideInDown' );
					stickyAddToCart[0].classList.remove( 'storefrontAS-sticky-add-to-cart--slideOutUp' );
				} else if ( stickyAddToCart[0].classList.contains( 'storefrontAS-sticky-add-to-cart--slideInDown' ) ) {
					stickyAddToCart[0].classList.add( 'storefrontAS-sticky-add-to-cart--slideOutUp' );
					stickyAddToCart[0].classList.remove( 'storefrontAS-sticky-add-to-cart--slideInDown' );
				}
			};
